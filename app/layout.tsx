...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      {/* v0 - built-with badge */}
  <div dangerouslySetInnerHTML={{ __html: `<div id="v0-built-with-button-4db7dad8-1702-49f8-b02f-20a5bb1639d9" style="
...
">
<a
  href="https://v0.app/chat/api/open/built-with-v0/vR2Fss7NRBJ?ref=QANT0J"
  target="_blank"
  rel="noopener"
  style="
    color: inherit;
...
<button
  onclick="document.getElementById('v0-built-with-button-4db7dad8-1702-49f8-b02f-20a5bb1639d9').style.display='none'"
